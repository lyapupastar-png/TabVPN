...
# Tor Browser .dmg), здесь источник — Tor Expert Bundle: обычный
# tar.gz с бинарём tor и зависимостями, без образов/установщиков —
# поэтому скрипт проще, монтировать ничего не нужно.
#
...
# должны сосуществовать в одной build/ директории.
